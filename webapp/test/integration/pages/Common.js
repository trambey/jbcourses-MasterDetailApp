sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("jbcourses/MasterDetailApp/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("jbcourses.MasterDetailApp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["jbcourses/MasterDetailApp/localService/mockserver"], function (mockserver) {
